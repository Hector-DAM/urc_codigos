...
df_combinaciones_hombre["fecha_nacimiento"] = df_combinaciones_hombre["fecha_nacimiento"].dt.strftime('%Y-%m-%d')
df_combinaciones_mujer["fecha_nacimiento"] = df_combinaciones_mujer["fecha_nacimiento"].dt.strftime('%Y-%m-%d')
...
# Convert DataFrame to JSON with birthdate in string format
json_data = result_df.to_json(orient='records', lines=True, date_format='utf-8')
